...
<body>
    ...
    <div class="Layout" style="font-family: 'Mali', cursive;">
        ...
        <br>
        <div class="Brands">
            <h2> highlight pen </h2><br>
        </div>

        <div class="display-section">
            <?php
                $items = $pdo->prepare("SELECT * FROM item where Type_item = 'HighlightPen' ");
                $items->execute();
                if ($items->rowCount() > 0) {
            ...
            <div class="box">
                <form action="../../../cart.php" method="post">
                    <div class="img-shoe">
                        <img src="../highlight_pen/imghighlight_pen/<?php echo $row['Image_item']; ?>.jpg" width="330px" height="200px">
                    </div>
                    <div class="item-name">
